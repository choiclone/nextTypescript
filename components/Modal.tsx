...
function Modal() {
    ...
    const handleList = async () => {
        if (addedToList) {
            ...
            toast(`${movie?.title || movie?.original_name} has been removed to My List`, {
                duration: 8000,
                style: toastStyle,
            });
        } else {
    ...
    return (
        <MuiModal open={showModal} onClose={handleClose} className="flxex !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden
